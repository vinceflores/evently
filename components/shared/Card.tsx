  ...
  return (
    <div className="group relative flex min-h-[300px] w-full max-w-[400px] flex-col overflow-hidden rounded-xl bg-white shadow-md transition-all hover:shadow-lg md:min-h-[438px]">
      ...
      {isEventCreator && !hidePrice && (
        <div className="absolute top-2 right-2 flex  gap-4 rounded-xl bg-white p-3 shadow-sm transition-all">
      ...
      <div className="flex min-h-[213px]  flex-col gap-3 p-5 md:gap-4">
        {!hidePrice && (
          <div className="flex gap-2 items-center">
            <span className="p-semibold-17 w-min rounded-full bg-green-100 px-4 py-1 ">
        ...
        <div className="flex-between w-full ">
          <p className="text-grey-500 p-medium-14 md:p-medium-16">
            {event.organizer.firstName} {event.organizer.lastName}
          </p>
          {hasOrderLink && (
            <Link href={`order?/eventId=${event.id}`} className="flex gap-2">
